...
const STORAGE_KEY = "jobsched-v13-dashboard-custom-roster-aim";
...
function getReadiness(job) {
  ...
  if (!getJobTrades(job).length) missing.push("required trade");
