...
function App() {
  ...
  function handleDragStart(e, jobId, sourceWorkerId = "", sourceDate = "") {
    ...
    e.dataTransfer.setData("application/json", JSON.stringify({ jobId, sourceWorkerId, sourceDate }));
